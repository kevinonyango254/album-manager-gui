...
package() {
    ...
    install -Dm 777 $srcdir/albums.json "$pkgdir/usr/lib/album-manager-gui/albums.json"
    install -Dm 777 $srcdir/cridentials.txt "$pkgdir/usr/lib/album-manager-gui/cridentials.txt"
